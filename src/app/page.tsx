    ...
    <div className="bg-slate-50">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Capture youre favorite memories with your own,
      ...
      <section className="bg-slate-100 py-24">
        <MaxWithWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-col-2 gap-y-16 ">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "The case feels durable and I even got a comoliment on the
                  design. Had the case for two and a half months now and
                  <span className="p-0.5 bg-purple-950 text-white traking m-px">
                    the image is super clear
                  </span>{" "}
                  on the case I had befor, the image started fading into
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Amin</p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "I usually keep my phone together with my keys in my pocket and that led to some pretty heavy scratchmarks on all of my last phone caases. this one, besides a barelt noticeable scratch on the corner, {' '}
                  <span className="p-0.5 bg-purple-950 text-white traking m-px">
              ...
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Milad</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-purple-600" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
